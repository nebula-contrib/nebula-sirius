...
generate-from-contracts:
		thrift --gen go:package_prefix=github.com/egasimov/nebula-sirius/ -out  . thriftfiles/graph.thrift \

		thrift --gen go:package_prefix=github.com/egasimov/nebula-sirius/ -out . thriftfiles/meta.thrift \

		thrift --gen go:package_prefix=github.com/egasimov/nebula-sirius/ -out . thriftfiles/storage.thrift \

		thrift --gen go:package_prefix=github.com/egasimov/nebula-sirius/ -out . thriftfiles/common.thrift

...
func TestGenerateTagTTLDefinitionStatement(t *testing.T) {
	testCases := GetTestCasesForGenerateTagTTLDefinitionStatement()
	for _, testcase := range testCases {
		actual, err := tag_alter.GenerateTTlDefinitionStatement(testcase.Given)

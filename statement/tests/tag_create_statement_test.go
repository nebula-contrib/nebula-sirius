...
func TestGenerateCreateTagStatement(t *testing.T) {
	testCases := GetTestCasesForGenerateCreateTagStatement()
	for _, testcase := range testCases {
		actual, err := tag_create.GenerateCreateTagStatement(testcase.Given)
